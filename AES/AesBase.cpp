...
AESLookupTable::AESLookupTable()
{
}

AESLookupTable& AESLookupTable::getInstance()
{
	static AESLookupTable instance;
	return instance;
}
...
int AESLookupTable::getSBoxValue(int n)
{
	static int sbox[256] = {
...
int AESLookupTable::getInvSBoxValue(int n)
{
	static int invSbox[256] = {
